...
4. **Maps codebase ↔ design with a comment sitemap** — a one-line `// figma: <url>` convention on every screen / component file. Lets future engineers (and agents) jump between code and design without leaving the editor.
