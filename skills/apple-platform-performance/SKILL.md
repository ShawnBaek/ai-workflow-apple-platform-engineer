...
|------|-------|--------------|
| **Part I — SwiftUI body cost & dependency tracking** | 1–6: `@State` placement, `Equatable` views, `LazyVStack`, stable `ForEach` IDs, work-outside-body, SwiftUI Instruments | "Body fires 200×/frame", "list scroll feels heavy", "scope my state". [`part-1-body-cost.md`](./part-1-body-cost.md) |
